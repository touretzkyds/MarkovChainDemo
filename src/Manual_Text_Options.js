...
export default function ManualTextOptions(props){
    ...
    const {nGramDict, modelType, generatedText, setGeneratedText, currentWord, setCurrentWord, key, setKey, enableNextWord, setEnableNextWord, wordOptions, nodesAdded, setNodesAdded, setWordOptions} = useDictContext();
    ...
    return (
        <div className = "manual-text-pane" class = "flex flex-col w-3/12 p-2 space-y-2 h-full rounded-md outline outline-green-100 bg-white overflow-y-auto text-center items-center">
